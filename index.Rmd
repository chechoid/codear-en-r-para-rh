---
title: "Codear en R para RRHH"
subtitle: "Una breve guía para aprender a programar <br> y vivir para contarlo"
author: 
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "https://github.com/chechoid/codear-en-r-para-rh") %>% 
  meta_social(
    title = "Codear en R para RRHH: Una breve guía para aprender a programar y vivir para contarlo",
    description = paste(
      "Esta es la presentación para la conferencia People Analytics World 2021 sobre consejos sobre cómo empezar a programar en R y lograr avances en el aprendizaje",
      "Desarrollada por Sergio Garcia Mora."
    ),
    url = "http://bit.ly/paw21-es-r4hr",
...
---
class: center, middle
background-image: url("Archivos/dataiq.png")
...
.pull-left[
`r icons::fontawesome("link")` Presentación: [bit.ly/paw21-es-r4hr](http://bit.ly/paw21-es-r4hr)
